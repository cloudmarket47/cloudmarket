...
function CollapsiblePreviewPanel({
  title,
  summary,
  children,
}: {
...
export function Settings() {
  ...
  return (
    <div className="space-y-8">
      <section
        className={`rounded-[2rem] border p-6 shadow-[0_24px_60px_rgba(15,23,42,0.06)] md:p-8 ${
          isDarkMode
      ...
      >
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className={`mt-3 max-w-2xl text-sm leading-7 md:text-base ${isDarkMode ? 'text-slate-300' : 'text-slate-600'}`}>
          ...
          <div className={`rounded-[1.6rem] border px-5 py-4 shadow-sm backdrop-blur ${isDarkMode ? 'border-white/10 bg-white/[0.06]' : 'border-white/70 bg-white/80'}`}>
        ...
        {feedbackMessage ? (
          <div className={`mt-5 rounded-[1.4rem] border px-4 py-3 text-sm font-medium ${isDarkMode ? 'border-[#2B63D9]/30 bg-[#2B63D9]/12 text-[#9fc2ff]' : 'border-[#bfdbfe] bg-[#eff6ff] text-[#1d4ed8]'}`}>
            {feedbackMessage}
          </div>
        ) : null}
      </section>
        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_18px_48px_rgba(15,23,42,0.05)] md:p-7">
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-[0.9fr,1.1fr]">
            <CollapsiblePreviewPanel
              title="Brand preview"
              summary="Logo and storefront identity stay hidden until you open this preview."
            >
      ...
      <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_18px_48px_rgba(15,23,42,0.05)] md:p-7">
        ...
        <div className="mt-6 grid gap-6 xl:grid-cols-[0.95fr,1.05fr]">
          <CollapsiblePreviewPanel
            title="Homepage highlight preview"
            summary="Open to inspect the current storefront highlight image arrangement."
          >
          ...
          <div className="space-y-5">
            ...
            <CollapsiblePreviewPanel
              title="Stored homepage highlight images"
              summary={`${brandingForm.homepageHighlightImages.length} image${brandingForm.homepageHighlightImages.length === 1 ? '' : 's'} available. Open to reveal.`}
            >
                ...
                >
                  <div className="grid gap-4 md:grid-cols-[11rem,1fr]">
                    <CollapsiblePreviewPanel
                      ...
                      summary={currentImage ? 'Open to reveal the current category image.' : 'No custom image saved. Using storefront fallback.'}
                    >
