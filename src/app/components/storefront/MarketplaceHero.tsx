      ...
      <div className="relative z-20 mx-auto max-w-7xl px-4 py-8 sm:px-6 md:py-10 lg:py-14">
        ...
        <div className="marketplace-hero-copy-halo mx-auto max-w-[860px] text-center">
          ...
          >
            <div
              ref={categoryMenuRef}
              className="relative flex w-full max-w-[500px] items-center justify-between gap-3"
            >
              <div className="relative">
                <button
                  type="button"
              ...
              {isCategoryMenuOpen ? (
                <div className="absolute left-1/2 top-[calc(100%+0.75rem)] z-30 w-[min(92vw,42rem)] max-w-[calc(100vw-1.5rem)] -translate-x-1/2 overflow-hidden rounded-[1.9rem] border border-slate-200 bg-white/96 p-3 text-left shadow-[0_24px_60px_rgba(15,23,42,0.16)] backdrop-blur-xl">
